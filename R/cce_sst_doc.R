...
#'   }
#' @source {Shore Stations Program. 2019. Daily sea-surface temperature measurements, collected and provided by the Shore Stations Program, La Jolla CA, 1916 - May 2019 ver 4. Environmental Data Initiative. https://doi.org/10.6073/pasta/d8e2473a3de462bd4d75bad8f934a40a (Accessed 2021-03-01).}
#' \url{https://portal.edirepository.org/nis/mapbrowse?packageid=knb-lter-cce.15.4}

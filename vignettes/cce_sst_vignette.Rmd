...
### Seasonal plot is always a powerful visualization
### Since this data does not have a season column, you can create a new variable season youself using dates \
#### So when does f/w/s/u start?
#### According to article from national geographic(https://www.nationalgeographic.org/encyclopedia/season/), it actually varies a bit each year 
```{r}
watertemp <- watertemp %>%
    mutate(month_day=as.Date(paste(2224, month, day, sep = "/" )))
```
